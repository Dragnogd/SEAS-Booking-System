...
<div class="content">
  <div class="container-fluid">
	<div class="row">
	  <div class="col-lg-12">
		<div class="card">
		  <div id="loansTable" class="card-body table-responsive p-0">
			<?php
				echo $this->ManageBookings_model->getListOfLoans();
			?>
		  </div>
		</div>
	  </div>
...
<!-- /.content-wrapper -->
    ...
    <script type="text/javascript">
        ...
        function init(){
                ...
                bootbox.confirm({
                    ...
                    callback: function (result) {
                        if(result){
                            ...
                            jQuery.ajax({
                                type: "POST",
                                url: "<?php echo base_url(); ?>" + "index.php/managebookings/completeLoan",
                                data: {loanID: uniqueID},
                                success: function(message) {
                                    toastr.success('Setup completed for ' + user);
                ...
                var modal = bootbox.dialog({
                    ...
                    buttons: [
                    {
                        ...
                        callback: function(result) {
                            ...
                            //Title
                            var setupTitle = $(".modal-body #bookingTitleInput").val();

                            //Location
                            var setupLocation = $(".modal-body #bookingLocationInput").val();
                            ...
                            if(errorFound == false){
                                ...
                                jQuery.ajax({
                                    type: "POST",
                                    url: "<?php echo base_url(); ?>" + "index.php/managebookings/insertBooking",
                                    data: {assets: assets, loanStartDate: loanStartDate, loanEndDate: loanEndDate, additionalDetails: additionalDetails, loanStartPeriod: loanStartPeriod, loanEndPeriod: loanEndPeriod, bookingType: bookingType, bookingPeriod: bookingPeriod, selectedUser: selectedUser, setupTitle: setupTitle, setupLocation: setupLocation},
                                    dataType: 'json',
                                        ...
                                        $.each(objJSON, function(index, element) {
                                            ...
                                            if(element == "Success"){
                                                ...
                                                if(severity == "success"){
                                                    ...
                                                    jQuery.ajax({
                                                        type: "POST",
                                                        url: "<?php echo base_url(); ?>" + "index.php/managebookings/getListOfLoans",
                                                        success: function(message){
                                            ...
                                            if(element == "Success"){
                                                ...
                                                if(severity == "success"){
                                                    ...
                                                    window.setTimeout(function() {
                                                        window.location.href = "<?php echo site_url('managebookings'); ?>";
                                                    }, 5000);
                                                }else if(severity == "warning" || severity == "danger"){
                                                    $.notify({
                                                        // options
            ...
            function checkDateInformation(){
				...
				if(loanType == "multi"){
					if(loanStartDateFilled && loanEndDateFilled){
						...
						jQuery.ajax({
							type: "POST",
							url: "<?php echo base_url(); ?>" + "index.php/managebookings/getAvaliableEquipementMulti",
					...
					if(selectLoanDateFilled && startPeriodFilled && endPeriodFilled){
						...
						jQuery.ajax({
							type: "POST",
							url: "<?php echo base_url(); ?>" + "index.php/managebookings/getAvaliableEquipementSingle",
            ...
            $(document).on('input', '#selectBookingID', function(e) {
                ...
                jQuery.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>" + "index.php/managebookings/getLoanInfo",
                    data: {loanID: loanID},
                    success: function(loanID) {
                        ...
                        jQuery.ajax({
                            type: "POST",
                            url: "<?php echo base_url(); ?>" + "index.php/managebookings/getEquipmentFromLoanID",
                            data: {loanID: loanID},
    ...
    <div class="form-content createBooking" style="display: none;">
        <form>
            ...
            <!-- Booking Title -->
            <label for="bookingTitle">Title for Setup</label>
            <input type="text" class="form-control" id="bookingTitleInput">

            <!-- Location -->
            <label for="bookingLocation">Location of Setup</label>
            <input type="text" class="form-control" id="bookingLocationInput">
            ...
            <select class="form-control" id="userSelected">
                ...
                <?php echo $this->ManageBookings_model->getStaff() ?>
            </select>
