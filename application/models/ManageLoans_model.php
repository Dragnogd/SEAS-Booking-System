...
class ManageLoans_model extends CI_Model {
    public function getListOfLoans()
	{
        ...
        $htmlString = "<table id='loansTable' class='table table-hover'><thead><tr><th scope='col'>ID</th><th scope='col'>User</th><th scope='col'>Start Date</th><th scope='col'>End Date</th><th scope='col'>Start Time</th><th scope='col'>End Time</th><th scope='col'>Additional Notes</th><th scope='col'>Status</th><th scope='col'>Assets</th><th scope='col'>Complete Booking</th></tr></thead><tbody>";
            ...
            if($loanType == "bookingLoan"){
                if($loanStatus != "Completed"){
					...
					if($loanStatus != "Reserved"){
						$htmlString .= "<tr color:white;' id='$loanBookingID'><td>$loanBookingID</td><td>$name</td><td>$loanStartDate</td><td>$loanEndDate</td><td>$loanStartPeriod</td><td>$loanEndPeriod</td><td style='max-width:300px; word-wrap:break-word'>$additionalNotes</td><td>$loanStatusHTML</td><td>$assetsList</td><td><button type='button' class='completeBooking btn btn-block btn-success'>Book In</button></td></tr>";
					}else{
						$htmlString .= "<tr color:white;' id='$loanBookingID'><td>$loanBookingID</td><td>$name</td><td>$loanStartDate</td><td>$loanEndDate</td><td>$loanStartPeriod</td><td>$loanEndPeriod</td><td style='max-width:300px; word-wrap:break-word'>$additionalNotes</td><td>$loanStatusHTML</td><td>$assetsList</td><td><div class='btn-group'><button type='button' class='bookReservation btn btn-primary'>Book Out</button><button' type='button' class='cancelReservation btn btn-danger'>Cancel</button></div></td></tr>";
					}
